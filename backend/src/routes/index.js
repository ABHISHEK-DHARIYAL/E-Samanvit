 ...
 *
 * Status: /health, /citizen-data, /consent, /audit, /services, and
 * (as of Prompt 7) /applications have real behaviour. /status remains
 * a reserved, empty router with zero endpoints (see status.routes.js)
 * — the Status Aggregator is not built yet.
 */
