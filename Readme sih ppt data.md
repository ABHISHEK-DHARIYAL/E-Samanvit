...
- Problem: _System integration and interoperability among government
  digital platforms, resulting in fragmented service delivery_
...
- **Provenance-aware data**: every auto-filled value visibly shows _where_
  it came from and _when_ it was verified — not a black box
...
- **Positioning:** _"This is a working interoperability prototype. Real
...
3. Explain _why_ consent is required
