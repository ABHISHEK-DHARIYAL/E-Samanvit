...
const Icons = {
  ...
  services: '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="7" height="7" x="3" y="3" rx="1"/><rect width="7" height="7" x="14" y="3" rx="1"/><rect width="7" height="7" x="14" y="14" rx="1"/><rect width="7" height="7" x="3" y="14" rx="1"/></svg>',
  resources: '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 19.5v-15A2.5 2.5 0 0 1 6.5 2H20v20H6.5a2.5 2.5 0 0 1 0-5H20"/></svg>',
  schemes: '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 2 2 7l10 5 10-5-10-5Z"/><path d="m2 17 10 5 10-5"/><path d="m2 12 10 5 10-5"/></svg>',
  ...
  logout: '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"/><polyline points="16 17 21 12 16 7"/><line x1="21" x2="9" y1="12" y2="12"/></svg>',
  ...
  edit: '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17 3a2.85 2.83 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5Z"/></svg>',
  ...
  alertCircle: '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><line x1="12" x2="12" y1="8" y2="12"/><line x1="12" x2="12.01" y1="16" y2="16"/></svg>',
  ...
  shoppingBag: '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M6 2 3 6v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6l-3-4Z"/><path d="M3 6h18"/><path d="M16 10a4 4 0 0 1-8 0"/></svg>',
  ...
  // Category & Section Icons (Refined per Design References)
  student: '<svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2L1 7.5L12 13L21.5 8.25V14.5H23V7.5L12 2Z"/><path d="M5 10.5V14.5C5 17.8 8.1 20 12 20C15.9 20 19 17.8 19 14.5V10.5L12 14L5 10.5Z"/><path d="M21.5 8.5V16.5C20.7 16.7 20.2 17.3 20.2 18V20.5C20.2 21.3 20.9 22 21.7 22H22.3C23.1 22 23.8 21.3 23.8 20.5V18C23.8 17.3 23.3 16.7 22.5 16.5V8.5H21.5Z"/></svg>',
  graduationCap: '<svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2L1 7.5L12 13L21.5 8.25V14.5H23V7.5L12 2Z"/><path d="M5 10.5V14.5C5 17.8 8.1 20 12 20C15.9 20 19 17.8 19 14.5V10.5L12 14L5 10.5Z"/><path d="M21.5 8.5V16.5C20.7 16.7 20.2 17.3 20.2 18V20.5C20.2 21.3 20.9 22 21.7 22H22.3C23.1 22 23.8 21.3 23.8 20.5V18C23.8 17.3 23.3 16.7 22.5 16.5V8.5H21.5Z"/></svg>',
  farmer: '<svg width="24" height="24" viewBox="0 0 24 24" fill="none"><circle cx="12" cy="12" r="10.5" fill="#fef3c7" stroke="#f59e0b" stroke-width="1.2"/><path d="M7 8C6 6.5 6.5 4.5 8.5 3.5C10.5 2.5 13.5 2.5 15.5 3.5C17.5 4.5 18 6.5 17 8C16.5 6.5 14.5 5 12 5C9.5 5 7.5 6.5 7 8Z" fill="#ffffff" stroke="#b45309" stroke-width="1"/><path d="M15.5 3.5L18 1.5L20 3L17.5 4.8" stroke="#b45309" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" fill="#ffffff"/><path d="M8 8V10.5C8 12.7 9.8 14.5 12 14.5C14.2 14.5 16 12.7 16 10.5V8" fill="#fed7aa" stroke="#78350f" stroke-width="1"/><path d="M9 11.8C10.2 12.6 11.2 12 12 12C12.8 12 13.8 12.6 15 11.8C15.5 12.5 14.5 13.2 13.5 13C12.5 12.8 12.3 12.8 12 12.8C11.7 12.8 11.5 12.8 10.5 13C9.5 13.2 8.5 12.5 9 11.8Z" fill="#1e293b"/><path d="M8 15L7 21H10L10.5 16" fill="#15803d" stroke="#166534" stroke-width="0.8"/><path d="M16 15L17 21H14L13.5 16" fill="#15803d" stroke="#166534" stroke-width="0.8"/><path d="M10 15H14V17H10V15Z" fill="#ffffff" stroke="#15803d" stroke-width="0.8"/></svg>',
  health: '<img src="assets/categories/health_logo.png" alt="Health & Medical" class="cat-icon-img">',
  housing: '<img src="assets/categories/housing_logo.png" alt="Housing & Shelter" class="cat-icon-img invert-on-dark">',
  senior: '<img src="assets/categories/senior_logo.png" alt="Senior Citizen" class="cat-icon-img invert-on-dark">',
  women: '<img src="assets/categories/women_logo.png" alt="Women & Child Welfare" class="cat-icon-img invert-on-dark">',
  family: '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="9" cy="6" r="3"/><circle cx="17" cy="11" r="2.2"/><path d="M3 21v-3a5 5 0 0 1 10 0v3"/><path d="M14 21v-2a3.5 3.5 0 0 1 7 0v2"/></svg>',
  ...
  filePlus: '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M15 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7Z"/><path d="M14 2v4a2 2 0 0 0 2 2h4"/><path d="M9 15h6"/><path d="M12 12v6"/></svg>',
  refresh: '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 12a9 9 0 0 0-9-9 9.75 9.75 0 0 0-6.74 2.74L3 8"/><path d="M3 3v5h5"/><path d="M3 12a9 9 0 0 0 9 9 9.75 9.75 0 0 0 6.74-2.74L21 16"/><path d="M16 21h5v-5"/></svg>',
  ...
  zap: '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"/></svg>',
  ...
  arrowRight: '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h14"/><path d="m12 5 7 7-7 7"/></svg>',
  externalLink: '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M15 3h6v6"/><path d="M10 14 21 3"/><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"/></svg>',
  ...
  activity: '<svg width="24" height="24" viewBox="0 0 24 24" fill="none"><path d="M12 21.35L10.55 20.03C5.4 15.36 2 12.28 2 8.5C2 5.42 4.42 3 7.5 3C9.24 3 10.91 3.81 12 5.09C13.09 3.81 14.76 3 16.5 3C19.58 3 22 5.42 22 8.5C22 12.28 18.6 15.36 13.45 20.04L12 21.35Z" fill="#ef4444"/><path d="M7.5 10.5L11.5 14.8L16.5 9.2" stroke="#ffffff" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round"/></svg>',

  // Why Choose e-Samanvit — Clean, Simple & Elegant Section Icons
  whyEasyAccess: '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="3" width="13" height="11" rx="2"/><path d="M5 18h7"/><path d="M8.5 14v4"/><rect x="15" y="8" width="7" height="13" rx="1.5"/><circle cx="18.5" cy="18" r="0.75" fill="currentColor"/></svg>',
  whyVerified: '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><path d="m9 15 2 2 4-4"/></svg>',
  whyDigital: '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><line x1="2" y1="12" x2="22" y2="12"/><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"/></svg>',
  whyGrowth: '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><polyline points="22 7 13.5 15.5 8.5 10.5 2 17"/><polyline points="16 7 22 7 22 13"/><line x1="2" y1="21" x2="22" y2="21"/></svg>',
  whyHelpline: '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M3 11h2a2 2 0 0 1 2 2v4a2 2 0 0 1-2 2H3a1 1 0 0 1-1-1v-6a1 1 0 0 1 1-1Z"/><path d="M21 11h-2a2 2 0 0 0-2 2v4a2 2 0 0 0 2 2h2a1 1 0 0 0 1-1v-6a1 1 0 0 0-1-1Z"/><path d="M2 15a10 10 0 0 1 20 0"/><path d="M19 19a3 3 0 0 1-3 3h-3"/></svg>',
  whyTransparent: '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10"/><path d="m9 12 2 2 4-4"/></svg>',
};
// ── Toast Notifications ───────────────────────────────────────
function showToast(message, type = 'info', duration = 4000) {
  ...
  const iconMap = { success: Icons.check, error: Icons.alertCircle, info: Icons.about, warning: Icons.alertCircle };
  const toast = document.createElement('div');
  toast.className = `toast toast-${type}`;
  toast.innerHTML = `${iconMap[type] || Icons.about}<span>${message}</span><button class="toast-close" onclick="this.parentElement.classList.add('leaving');setTimeout(()=>this.parentElement.remove(),250)">${Icons.x}</button>`;
...
function updatePasswordStrength(password, containerId) {
  ...
  const textEl = container.parentElement.querySelector('.password-strength-text');
  const cls = getPasswordStrengthClass(score);
  ...
  if (textEl) {
    textEl.textContent = password.length > 0 ? `Password strength: ${getPasswordStrengthLabel(score)}` : '';
    textEl.className = 'password-strength-text';
    if (cls) textEl.classList.add(`text-${cls === 'weak' ? 'error' : cls === 'fair' ? 'warning' : cls === 'good' ? 'accent' : 'success'}`);
  }
}
...
document.addEventListener('click', (e) => {
  document.querySelectorAll('.dropdown.open, .notif-dropdown.open').forEach(dd => {
