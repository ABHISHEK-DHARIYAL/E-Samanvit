...
const App = {
  ...
  navigate(page, params = {}) {
    ...
    if (page === 'gov-services') {
      // A card elsewhere in the app (e.g. a Students-category scheme
      // card with a real backend schema) can jump straight into the
      // consent step for a specific service, instead of landing on
      // the generic service list. GovServices.onMount() reads this
      // and clears it immediately after use.
      window.govServicesPreselectedServiceId = (params && params.serviceId) ? params.serviceId : null;
    }
    window.scrollTo(0, 0);
    ...
    const renderers = {
      ...
      'scheme-detail':  typeof renderSchemeDetailPage !== 'undefined' ? renderSchemeDetailPage : null,
    };
    ...
    const titles = {
      ...
      'scheme-detail': 'Scheme Details - e-Samanvit',
    };
