...
**Scope of this document:** how e-Samanvit's _Scholarship Application_ flow goes
...
| `POST /api/citizen-data/fetch`, `POST /api/services/:id/prepare` | Fully working _internally_ — consent-checked, auto-filled, reviewable                                                                                          |
...
`GovernmentAdapter` only covers _reading_ data. Actually filing an
